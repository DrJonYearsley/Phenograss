...
# 
# 
# save(gls_phase1, phenology_wide, file=paste0(dataDir, '/gls_model_2017.Rdata'))
# 
# # +++++++++++++++++++++++++++++++++++++++++++++++++++++
# 
...
# #square = 20
# 
# tmp = subset(phenology_wide, year==2017 & !is.na(phase1_fit))
...
#                        & soilmoisture_mera$validityDate > '20170501'
#                        & soilmoisture_mera$validityDate < '20170901')
# 
#   # Create a geometry column
...
#   # ++++++++++++++++++++++++++++++++++++++++++++++
#   
#   # filename2 = paste0('Temp_subset_2012.RData')
#   # load(file.path(tempPath,filename2))
#   #
#   # # Select the square s in January / February / March
#   # mera_square = subset(mera_daily, mera_daily$square == s
#   #                      & mera_daily$validityDate < '20120401')
#   # 
#   # # Create a geometry column
#   # mera_square_sf = st_as_sf(mera_square, coords = c("Longitude", "Latitude"), 
#   #                           crs = st_crs("EPSG:4326"))
...
# 
#   # Select the square s
#   mera_square = subset(precipitation_mera, precipitation_mera$square == s
#                        & precipitation_mera$validityDate > '20170501'
#                        & precipitation_mera$validityDate < '20170901')
# 
#   # Create a geometry column
#   mera_square_sf = st_as_sf(mera_square, coords = c("Longitude", "Latitude"),
#                             crs = st_crs("EPSG:4326"))
...
# 
#   # Now do some ordinary krigging to interpolate
#   g_mod3 = gstat::krige(formula = Value ~ 1,
#                         locations=test,
#                         model=v_mod,
#                         newdata=crop_square)
# 
...
#     tmp$precipitation[ind] = as.numeric(st_extract(g_mod3, tmp$geometry[ind]))
#   }
# }
...
# Save tmp
#save(tmp, file=paste0(outputDir, '/gls_model_1_21_2017_elev_CAT_soilmoist_precip.Rdata'))
load(file.path(outputDir,'gls_model_1_21_2017_elev_CAT_soilmoist_precip.Rdata'))
...
ggsave(filename = 'gls2_fitted_vs_precip_CAT_year2017.png', width=30 , height=20, units='cm')
